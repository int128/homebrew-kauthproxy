class Kauthproxy < Formula
  ...
  url "https://github.com/int128/kauthproxy/releases/download/v0.1.0/kauthproxy_darwin_amd64.zip"
  version "v0.1.0"
  sha256 "adc44b32a0d7e84ad1f7d0a53bd9b70456f945a920e49fc7d898516e61110cfb"
  def install
